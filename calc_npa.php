...
$page_title = 'NPA Settlement & Restructuring';
$page_subtitle = 'Calculate revised EMI for overdue accounts';
...
<div class="view-container">
    ...
    <div class="calc-layout">
        <div class="calc-inputs">
            ...
            <div class="input-group"><label>Total Outstanding Dues</label><div class="input-wrapper"><span class="prefix">₹</span><input type="number" id="amt" value="1000000" oninput="calc()"></div></div>
            <div class="input-group"><label>Interest Waiver (%)</label><div class="input-wrapper"><input type="number" id="w" value="10" oninput="calc()"></div></div>
            <div class="input-group"><label>Revised Tenure (Months)</label><div class="input-wrapper"><input type="number" id="ten" value="60" oninput="calc()"></div></div>
            <div class="input-group"><label>Restructured Rate (%)</label><div class="input-wrapper"><input type="number" id="r" value="12" oninput="calc()"></div></div>
        </div>
        <div class="calc-results">
            <div class="res-label">New Restructured EMI</div>
            ...
            <div class="res-sub-grid">
                <div class="res-sub-item"><div class="s-lbl">Settlement Amount</div><div class="s-val" id="r-set">₹0</div></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function calc() { 
            ...
            const set = amt*(1 - (w/100));
            const emi = (r===0||ten===0)?0: ((r/1200)*set/(1-Math.pow(1+r/1200, -ten)));
            document.getElementById('res-main').innerText = '₹'+fmt(emi);
            document.getElementById('r-set').innerText = '₹'+fmt(set);
            if(chart) { chart.data.datasets[0].data = [set, amt-set]; chart.update(); }
         }
