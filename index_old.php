    ...
    if ($count == 0) {
        $dummy_clients = [
            [
                ...
                'turnover' => 'Gé¦5-10 Crores', 'employees' => 120, 'contact_name' => 'Amit Sharma', 'designation' => 'Director',
            ...
            [
                ...
                'turnover' => 'Gé¦1-5 Crores', 'employees' => 45, 'contact_name' => 'Priya Patel', 'designation' => 'Purchase Manager',
            ...
            [
                ...
                'turnover' => 'Gé¦10-25 Crores', 'employees' => 250, 'contact_name' => 'Rohan Murthy', 'designation' => 'CTO',
            ...
            [
                ...
                'turnover' => 'Gé¦1-5 Crores', 'employees' => 80, 'contact_name' => 'Subhash Bose', 'designation' => 'Operations Head',
            ...
            [
                ...
                'turnover' => 'Gé¦25-50 Crores', 'employees' => 150, 'contact_name' => 'Vikram Goel', 'designation' => 'Managing Director',
        ...
        // Mock Activity Logs
        $dummy_activities = [
            ['description' => 'Apex Industries added by Rahul Sharma GÇö 4 months ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-4 months'))],
            ['description' => 'Zenith Retail added by Karan Singh GÇö 3 months ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-3 months'))],
            ['description' => 'Nova Software Solutions added by Rahul Sharma GÇö 5 months ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-5 months'))],
            ['description' => 'Elite Exports added by Anjali Mehta GÇö 2 months ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-2 months'))],
            ['description' => 'Matrix Logistics added by Anjali Mehta GÇö Today 10am', 'created_at' => date('Y-m-d H:i:s', strtotime('-3 hours'))],
            ['description' => 'Email Pitch sent to Apex Industries by Rahul Sharma GÇö 25 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-25 days'))],
            ['description' => 'Presentation Deck (PPT) sent to Apex Industries by Rahul Sharma GÇö 15 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-15 days'))],
            ['description' => 'Quotation Q001 (Gé¦1,77,000) created for Apex Industries GÇö 8 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-8 days'))],
            ['description' => 'Quotation Q002 approved for Nova Software Solutions GÇö 30 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-30 days'))],
            ['description' => 'Quotation Q003 rejected by Elite Exports GÇö 18 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-18 days'))],
            ['description' => 'Email Pitch sent to Zenith Retail by Karan Singh GÇö 5 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-5 days'))]
        ];
    ...
    try {
        ...
        switch ($action) {
            ...
            case 'add_client':
                ...
                // Log Action
                $action_desc = "{$company_name} added by {$added_by} GÇö Today " . date('h:i A');
            ...
            case 'send_email':
                ...
                // Log activity feed
                $act_desc = "{$type} email sent to {$client['company_name']} by {$sent_by} GÇö " . date('h:i A');
            ...
            case 'save_quotation':
                ...
                // Write Activity logs
                $act_desc = "Quotation {$quotation_number} (Gé¦" . number_format($total_amount, 2, '.', ',') . ") drafted for {$c_name}";
                log_activity($act_desc);
            ...
            case 'save_settings':
                ...
                // Log activity
                $act_desc = "Company settings & profile updated by {$contact_person} GÇö Today " . date('h:i A');
                log_activity($act_desc);
            ...
            <form id="client-registration-form" onsubmit="saveClient(event)">
                <div class="card">
                    <div class="card-title-bar">
                        ...
                        <div class="badge-locked"><i data-lucide="lock"></i> Locked Entry GÇö Permanent Record</div>
                    </div>
                    
                    <!-- Business Information -->
                    <div class="form-section-title">=ƒÅó Business Information</div>
                    <div class="form-grid">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="turnover">
                                ...
                                <option value="Under Gé¦1 Crore">Under Gé¦1 Crore</option>
                                <option value="Gé¦1-5 Crores">Gé¦1-5 Crores</option>
                                <option value="Gé¦5-10 Crores">Gé¦5-10 Crores</option>
                                <option value="Gé¦10-25 Crores">Gé¦10-25 Crores</option>
                                <option value="Gé¦25-50 Crores">Gé¦25-50 Crores</option>
                                <option value="Gé¦50+ Crores">Gé¦50+ Crores</option>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-section-title">=ƒæ¿GÇì=ƒÆ+ Contact Person Details</div>
                    <div class="form-grid">
                        <div class="form-group">
                    ...
                    <!-- Address details -->
                    <div class="form-section-title">=ƒôì Address Details</div>
                    <div class="form-grid">
                    ...
                    <!-- Bank Details -->
                    <div class="form-section-title">=ƒÅª Bank Details (Optional)</div>
                    <div class="form-grid">
                        <div class="form-group">
                    ...
                    <!-- Other metadata info -->
                    <div class="form-section-title">=ƒô¥ Other Info</div>
                    <div class="form-grid">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="priority" required>
                                <option value="Hot">=ƒöÑ Hot</option>
                                <option value="Warm" selected>GÿÇn+Å Warm</option>
                                <option value="Cold">G¥än+Å Cold</option>
                            </select>
                        </div>
                        <div class="form-group">
            ...
            <div class="filters-drawer" id="crm-filters-drawer">
                <div class="form-group">
                    ...
                    <select id="filter-status" onchange="triggerSearch()">
                        ...
                        <option value="New">=ƒö¦ New</option>
                        <option value="Contacted">=ƒƒá Contacted</option>
                        <option value="In Negotiation">=ƒƒí In Negotiation</option>
                        <option value="Closed Won">=ƒƒó Closed Won</option>
                        <option value="Closed Lost">=ƒö¦ Closed Lost</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <table class="items-table" id="quote-items-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 15%;">Rate (Gé¦)</th>
                                <th style="width: 15%;">Taxable Value (Gé¦)</th>
                    ...
                    <div class="summary-block-wrapper">
                        <div class="summary-block">
                            <div class="summary-row">
                                ...
                                <strong id="quote-subtotal">Gé¦0.00</strong>
                            </div>
                            <div class="summary-row">
                                <span>GST Amount:</span>
                                <strong id="quote-gst">Gé¦0.00</strong>
                            </div>
                            <div class="summary-row grand-total">
                                <span>Grand Total:</span>
                                <strong id="quote-grand-total">Gé¦0.00</strong>
                            </div>
                        </div>
                    </div>
                <div class="form-actions">
        ...
        <div id="view-leads" class="view-container">
            ...
            <div class="stats-grid" style="grid-template-columns: repeat(4,1fr); margin-bottom:1.5rem;">
                <div class="stat-card" style="border-left:4px solid #6366f1;">
                    ...
                    <div class="stat-value" id="lead-stat-total">GÇö</div>
                </div>
                <div class="stat-card" style="border-left:4px solid var(--danger);">
                    ...
                    <div class="stat-value" id="lead-stat-hot">GÇö</div>
                </div>
                <div class="stat-card" style="border-left:4px solid var(--success);">
                    ...
                    <div class="stat-value" id="lead-stat-won">GÇö</div>
                </div>
                <div class="stat-card" style="border-left:4px solid var(--secondary);">
                    ...
                    <div class="stat-value" id="lead-stat-progress">GÇö</div>
                </div>
            </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 2fr; gap:1.5rem; align-items:start;">
                ...
                <div class="card" style="position:sticky;top:20px;">
                    <div class="card-title-bar">
                        <h2 id="lead-form-title">GPò New Lead</h2>
                        <button type="button" class="btn btn-secondary" style="padding:4px 10px;font-size:12px;margin-left:auto;" onclick="openBulkUploadModal()">=ƒôñ Bulk Upload</button>
                    </div>
                    <form id="lead-form" onsubmit="saveLead(event)">
                        ...
                        <div class="form-grid" style="grid-template-columns:1fr 1fr;">
                            ...
                            <div class="form-group">
                                ...
                                <select name="priority" id="lf-priority">
                                    ...
                                    <option value="Warm" selected>=ƒƒí Warm</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="stage" id="lf-stage">
                                ...
                                <option value="Won">Won G£à</option>
                                <option value="Lost">Lost G¥î</option>
                            </select>
                        </div>
                        <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="stats-grid" style="grid-template-columns: repeat(4, 1fr); margin-top: 14px; margin-bottom: 24px;">
                    <div class="stat-card" style="padding: 16px;">
                        ...
                        <div class="stat-value" id="qs-total" style="font-size: 20px; margin-top: 4px;">Gé¦0.00</div>
                    </div>
                    <div class="stat-card" style="padding: 16px; border-left: 4px solid var(--warning);">
                        ...
                        <div class="stat-value" id="qs-pending" style="font-size: 20px; color: var(--warning); margin-top: 4px;">Gé¦0.00</div>
                    </div>
                    <div class="stat-card" style="padding: 16px; border-left: 4px solid var(--success);">
                        ...
                        <div class="stat-value" id="qs-approved" style="font-size: 20px; color: var(--success); margin-top: 4px;">Gé¦0.00</div>
                    </div>
                    <div class="stat-card" style="padding: 16px; border-left: 4px solid var(--danger);">
                        ...
                        <div class="stat-value" id="qs-rejected" style="font-size: 20px; color: var(--danger); margin-top: 4px;">Gé¦0.00</div>
                    </div>
                </div>
                    ...
                    <table class="quotation-list-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 15%;">Subtotal (Gé¦)</th>
                                <th style="width: 15%;">GST Amount (Gé¦)</th>
                                <th style="width: 15%;">Total Value (Gé¦)</th>
        ...
        <div id="view-settings" class="view-container">
            <form id="settings-form" onsubmit="saveCompanySettings(event)">
                <div class="card">
                    ...
                    <div class="form-section-title">=ƒÅó Company Profile & Billing Details</div>
                    <div class="form-grid">
                        <div class="form-group">
                    ...
                    <div class="form-section-title">=ƒÅª Bank Payment Details (Shown on Invoices)</div>
                    <div class="form-grid">
                        <div class="form-group">
                            <label>Bank Name</label>
                    ...
                    <div class="form-section-title">=ƒæñ User / Staff Account</div>
                    <div class="form-grid">
                        <div class="form-group">
                    ...
                    <div class="form-section-title">=ƒôº SMTP Email Configuration</div>
                    <div class="form-grid">
                        <div class="form-group">
            ...
            <form id="create-user-form" onsubmit="createUser(event)">
                <div class="card">
                    ...
                    <div class="form-section-title">GPò Register New Staff</div>
                    <div class="form-grid">
                        <div class="form-group">
                    ...
                    <div class="form-section-title" style="margin-top: 2rem;">=ƒæÑ Existing Users</div>
            ...
            <div class="card">
                ...
                <div class="form-section-title">GPò Create New Template</div>
                ...
                <div class="form-section-title" style="margin-top: 2rem;">=ƒôÜ Saved Templates</div>
                ...
                function loadTemplatesList() {
                    ...
                    .then(data => {
                        ...
                        if (data.length === 0) {
                            ...
                            data.forEach(t => {
                                let attachBadge = t.attachment_name ? `<span style="font-size: 11px; background: var(--secondary-light); color: var(--secondary); padding: 2px 6px; border-radius: 4px; margin-left: 8px;">=ƒôÄ Attached File</span>` : '';
                                    ...
                                    if (currentUser && currentUser.role === 'Admin') {
                                        buttonsHtml = `
                                            <div style="display:flex; gap:0.5rem;">
                                                <button type="button" onclick="approveDeleteTemplate(${t.id})" style="padding: 0.4rem 0.8rem; font-size: 12px; background: #fee2e2; color: #ef4444; border: 1px solid #fca5a5; border-radius: 6px; cursor: pointer;">G£à Approve</button>
                                                <button type="button" onclick="rejectDeleteTemplate(${t.id})" style="padding: 0.4rem 0.8rem; font-size: 12px; background: #f3f4f6; color: #4b5563; border: 1px solid #d1d5db; border-radius: 6px; cursor: pointer;">G¥î Reject</button>
                                            </div>
                                        `;
                                    } else {
                                        buttonsHtml = `<span style="font-size:12px; color:#ef4444; border:1px solid #fca5a5; padding: 0.4rem 0.8rem; border-radius: 6px; background: #fee2e2;">=ƒö¦ Pending Admin Approval</span>`;
                                    }
                                } else {
                ...
                function applyEmailTemplate() {
                    ...
                    if (t) {
                        ...
                        if (t.attachment_name) {
                            badge.textContent = `=ƒôÄ Will automatically attach: ${t.attachment_name}`;
                                ...
                                data.forEach(p => {
                                    ...
                                    if (p.delete_requested == 1) {
                                        if (currentUser && currentUser.role === 'Admin') {
                                            buttonsHtml = `
                                                <div style="display:flex; gap:0.5rem;">
                                                    <button type="button" onclick="approveDeletePpt(${p.id})" style="padding: 4px 8px; font-size: 11px; background: #fee2e2; color: #ef4444; border: 1px solid #fca5a5; border-radius: 6px; cursor: pointer;">G£à Approve</button>
                                                    <button type="button" onclick="rejectDeletePpt(${p.id})" style="padding: 4px 8px; font-size: 11px; background: #f3f4f6; color: #4b5563; border: 1px solid #d1d5db; border-radius: 6px; cursor: pointer;">G¥î Reject</button>
                                                </div>
                                            `;
                                        } else {
                                            buttonsHtml = `<span style="font-size:11px; color:#ef4444; border:1px solid #fca5a5; padding: 4px 8px; border-radius: 6px; background: #fee2e2;">=ƒö¦ Pending</span>`;
                                        }
                                    } else {
            ...
            <div class="card">
                ...
                <div class="form-section-title">GPò Upload New Presentation</div>
                ...
                <div class="form-section-title" style="margin-top: 2rem;">=ƒôÜ Saved Presentations</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="bulk-preview-container" style="display:none; margin-top:15px; border-top: 1px solid var(--border); padding-top: 15px;">
                    <p style="font-weight:600; color:var(--success); text-align:center; margin-bottom:15px;">G£à <span id="bulk-record-count">0</span> records parsed successfully.</p>
                    ...
                    <div style="background:var(--bg-main); border-radius:8px; padding: 15px;">
                        ...
                        <div id="split-options-container" style="display:none; margin-top:10px; padding-left:25px;">
                            <label style="display:block; margin-bottom:5px;"><input type="radio" name="split_type" value="random" onchange="renderSplitUI()"> =ƒÄ¦ Split Randomly (Even/Odd)</label>
                            <label style="display:block; margin-bottom:5px;"><input type="radio" name="split_type" value="serial" onchange="renderSplitUI()"> =ƒöó Split by Serial</label>
                            <label style="display:block; margin-bottom:5px;"><input type="radio" name="split_type" value="location" onchange="renderSplitUI()"> =ƒôì Split by Location</label>
    ...
    <script>
                ...
                clients.forEach(c => {
                    ...
                    card.innerHTML = `
                        ...
                        <div class="client-card-meta">
                            ...
                            <span>${c.contact_name} GÇö ${c.designation || 'Client Contact'}</span>
                        </div>
                        <div class="client-card-meta">
        ...
        async function refreshClientDropdowns() {
            try {
                ...
                // Silent fail GÇö do not show error toast on initial load
        ...
        function addQuotationRow() {
            ...
            tr.innerHTML = `
                ...
                <td><input type="text" readonly value="Gé¦0.00" class="item-taxval" style="background:#f1f5f9; font-weight: 500;"></td>
                <td>
                ...
                tbody.innerHTML = leads.map(l => {
                    ...
                    return `<tr style="border-bottom:1px solid var(--border);transition:background .15s;" onmouseover="this.style.background='var(--bg-color)'" onmouseout="this.style.background=''">
                        <td style="padding:12px;">
                            ...
                            <div style="font-size:11px;color:var(--text-light);">${l.company_name || 'GÇö'}</div>
                        </td>
                        ...
                        <td style="padding:12px;font-size:12px;color:var(--text-light);">${l.assigned_to || 'GÇö'}</td>
                        <td style="padding:12px;">
                            <div style="display:flex;gap:6px;">
                                ${currentUser && currentUser.role === 'Admin' ? `<button class="btn btn-secondary" style="padding:4px 10px;font-size:11px;" onclick="editLead(${l.id})" title="Edit">G£Ån+Å</button>` : ''}
                                ...
                                ${currentUser && currentUser.role === 'Admin' ? `<button class="btn btn-danger" style="padding:4px 10px;font-size:11px;" onclick="deleteLead(${l.id})" title="Delete">=ƒùæn+Å</button>` : ''}
                            </div>
                        </td>
                    </tr>`;
                }).join('');
        ...
        async function editLead(id) {
            try {
                ...
                document.getElementById('lead-form-title').innerText = 'G£Ån+Å Edit Lead';
        ...
        function resetLeadForm() {
            ...
            document.getElementById('lead-form-title').innerText = 'GPò New Lead';
                    ...
                    <table style="width:100%; border-collapse: collapse; margin-bottom: 30px;">
                        <thead>
                            <tr style="background-color: #f8fafc; color:#ea580c;">
                                ...
                                <th style="border: 1px solid #cbd5e1; padding: 12px 10px; width: 14%; text-align: right;">Rate (Gé¦)</th>
                                <th style="border: 1px solid #cbd5e1; padding: 12px 10px; width: 10%; text-align: center;">GST</th>
                                <th style="border: 1px solid #cbd5e1; padding: 12px 10px; width: 14%; text-align: right;">Total (Gé¦)</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${rowsHtml}
