    ...
    if ($count == 0) {
        $dummy_clients = [
            [
                ...
                'turnover' => 'Γé╣5-10 Crores', 'employees' => 120, 'contact_name' => 'Amit Sharma', 'designation' => 'Director',
            ...
            [
                ...
                'turnover' => 'Γé╣1-5 Crores', 'employees' => 45, 'contact_name' => 'Priya Patel', 'designation' => 'Purchase Manager',
            ...
            [
                ...
                'turnover' => 'Γé╣10-25 Crores', 'employees' => 250, 'contact_name' => 'Rohan Murthy', 'designation' => 'CTO',
            ...
            [
                ...
                'turnover' => 'Γé╣1-5 Crores', 'employees' => 80, 'contact_name' => 'Subhash Bose', 'designation' => 'Operations Head',
            ...
            [
                ...
                'turnover' => 'Γé╣25-50 Crores', 'employees' => 150, 'contact_name' => 'Vikram Goel', 'designation' => 'Managing Director',
        ...
        // Mock Activity Logs
        $dummy_activities = [
            ['description' => 'Apex Industries added by Rahul Sharma ΓÇö 4 months ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-4 months'))],
            ['description' => 'Zenith Retail added by Karan Singh ΓÇö 3 months ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-3 months'))],
            ['description' => 'Nova Software Solutions added by Rahul Sharma ΓÇö 5 months ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-5 months'))],
            ['description' => 'Elite Exports added by Anjali Mehta ΓÇö 2 months ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-2 months'))],
            ['description' => 'Matrix Logistics added by Anjali Mehta ΓÇö Today 10am', 'created_at' => date('Y-m-d H:i:s', strtotime('-3 hours'))],
            ['description' => 'Email Pitch sent to Apex Industries by Rahul Sharma ΓÇö 25 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-25 days'))],
            ['description' => 'Presentation Deck (PPT) sent to Apex Industries by Rahul Sharma ΓÇö 15 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-15 days'))],
            ['description' => 'Quotation Q001 (Γé╣1,77,000) created for Apex Industries ΓÇö 8 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-8 days'))],
            ['description' => 'Quotation Q002 approved for Nova Software Solutions ΓÇö 30 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-30 days'))],
            ['description' => 'Quotation Q003 rejected by Elite Exports ΓÇö 18 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-18 days'))],
            ['description' => 'Email Pitch sent to Zenith Retail by Karan Singh ΓÇö 5 days ago', 'created_at' => date('Y-m-d H:i:s', strtotime('-5 days'))]
        ];
    ...
    try {
        ...
        switch ($action) {
            ...
            case 'add_client':
                ...
                // Log Action
                $action_desc = "{$company_name} added by {$added_by} ΓÇö Today " . date('h:i A');
            ...
            case 'send_email':
                ...
                // Log activity feed
                $act_desc = "{$type} email sent to {$client['company_name']} by {$sent_by} ΓÇö " . date('h:i A');
            ...
            case 'save_quotation':
                ...
                // Write Activity logs
                $act_desc = "Quotation {$quotation_number} (Γé╣" . number_format($total_amount, 2, '.', ',') . ") drafted for {$c_name}";
                log_activity($act_desc);
            ...
            case 'save_settings':
                ...
                // Log activity
                $act_desc = "Company settings & profile updated by {$contact_person} ΓÇö Today " . date('h:i A');
                log_activity($act_desc);
            ...
            <form id="client-registration-form" onsubmit="saveClient(event)">
                <div class="card">
                    <div class="card-title-bar">
                        ...
                        <div class="badge-locked"><i data-lucide="lock"></i> Locked Entry ΓÇö Permanent Record</div>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select name="turnover">
                                ...
                                <option value="Under Γé╣1 Crore">Under Γé╣1 Crore</option>
                                <option value="Γé╣1-5 Crores">Γé╣1-5 Crores</option>
                                <option value="Γé╣5-10 Crores">Γé╣5-10 Crores</option>
                                <option value="Γé╣10-25 Crores">Γé╣10-25 Crores</option>
                                <option value="Γé╣25-50 Crores">Γé╣25-50 Crores</option>
                                <option value="Γé╣50+ Crores">Γé╣50+ Crores</option>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-section-title">≡ƒæ¿ΓÇì≡ƒÆ╝ Contact Person Details</div>
                    <div class="form-grid">
                        <div class="form-group">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select name="priority" required>
                                ...
                                <option value="Warm" selected>ΓÿÇ∩╕Å Warm</option>
                                <option value="Cold">Γ¥ä∩╕Å Cold</option>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <table class="items-table" id="quote-items-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 15%;">Rate (Γé╣)</th>
                                <th style="width: 15%;">Taxable Value (Γé╣)</th>
                    ...
                    <div class="summary-block-wrapper">
                        <div class="summary-block">
                            <div class="summary-row">
                                ...
                                <strong id="quote-subtotal">Γé╣0.00</strong>
                            </div>
                            <div class="summary-row">
                                <span>GST Amount:</span>
                                <strong id="quote-gst">Γé╣0.00</strong>
                            </div>
                            <div class="summary-row grand-total">
                                <span>Grand Total:</span>
                                <strong id="quote-grand-total">Γé╣0.00</strong>
                            </div>
                        </div>
                    </div>
                <div class="form-actions">
        ...
        <div id="view-leads" class="view-container">
            ...
            <div class="stats-grid" style="grid-template-columns: repeat(4,1fr); margin-bottom:1.5rem;">
                <div class="stat-card" style="border-left:4px solid #6366f1;">
                    ...
                    <div class="stat-value" id="lead-stat-total">ΓÇö</div>
                </div>
                <div class="stat-card" style="border-left:4px solid var(--danger);">
                    ...
                    <div class="stat-value" id="lead-stat-hot">ΓÇö</div>
                </div>
                <div class="stat-card" style="border-left:4px solid var(--success);">
                    ...
                    <div class="stat-value" id="lead-stat-won">ΓÇö</div>
                </div>
                <div class="stat-card" style="border-left:4px solid var(--secondary);">
                    ...
                    <div class="stat-value" id="lead-stat-progress">ΓÇö</div>
                </div>
            </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 2fr; gap:1.5rem; align-items:start;">
                ...
                <div class="card" style="position:sticky;top:20px;">
                    <div class="card-title-bar">
                        <h2 id="lead-form-title">Γ₧ò New Lead</h2>
                    ...
                    <form id="lead-form" onsubmit="saveLead(event)">
                        ...
                        <div class="form-group">
                            ...
                            <select name="stage" id="lf-stage">
                                ...
                                <option value="Won">Won Γ£à</option>
                                <option value="Lost">Lost Γ¥î</option>
                            </select>
                        </div>
                        <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="stats-grid" style="grid-template-columns: repeat(4, 1fr); margin-top: 14px; margin-bottom: 24px;">
                    <div class="stat-card" style="padding: 16px;">
                        ...
                        <div class="stat-value" id="qs-total" style="font-size: 20px; margin-top: 4px;">Γé╣0.00</div>
                    </div>
                    <div class="stat-card" style="padding: 16px; border-left: 4px solid var(--warning);">
                        ...
                        <div class="stat-value" id="qs-pending" style="font-size: 20px; color: var(--warning); margin-top: 4px;">Γé╣0.00</div>
                    </div>
                    <div class="stat-card" style="padding: 16px; border-left: 4px solid var(--success);">
                        ...
                        <div class="stat-value" id="qs-approved" style="font-size: 20px; color: var(--success); margin-top: 4px;">Γé╣0.00</div>
                    </div>
                    <div class="stat-card" style="padding: 16px; border-left: 4px solid var(--danger);">
                        ...
                        <div class="stat-value" id="qs-rejected" style="font-size: 20px; color: var(--danger); margin-top: 4px;">Γé╣0.00</div>
                    </div>
                </div>
                    ...
                    <table class="quotation-list-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 15%;">Subtotal (Γé╣)</th>
                                <th style="width: 15%;">GST Amount (Γé╣)</th>
                                <th style="width: 15%;">Total Value (Γé╣)</th>
        ...
        <div id="view-settings" class="view-container">
            ...
            <form id="create-user-form" onsubmit="createUser(event)">
                <div class="card">
                    ...
                    <div class="form-section-title">Γ₧ò Register New Staff</div>
                    <div class="form-grid">
                        <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="form-section-title">Γ₧ò Create New Template</div>
                                    ...
                                    if (currentUser && currentUser.role === 'Admin') {
                                        buttonsHtml = `
                                            <div style="display:flex; gap:0.5rem;">
                                                <button type="button" onclick="approveDeleteTemplate(${t.id})" style="padding: 0.4rem 0.8rem; font-size: 12px; background: #fee2e2; color: #ef4444; border: 1px solid #fca5a5; border-radius: 6px; cursor: pointer;">Γ£à Approve</button>
                                                <button type="button" onclick="rejectDeleteTemplate(${t.id})" style="padding: 0.4rem 0.8rem; font-size: 12px; background: #f3f4f6; color: #4b5563; border: 1px solid #d1d5db; border-radius: 6px; cursor: pointer;">Γ¥î Reject</button>
                                            </div>
                                        `;
                                    } else {
                                ...
                                data.forEach(p => {
                                    ...
                                    if (p.delete_requested == 1) {
                                        if (currentUser && currentUser.role === 'Admin') {
                                            buttonsHtml = `
                                                <div style="display:flex; gap:0.5rem;">
                                                    <button type="button" onclick="approveDeletePpt(${p.id})" style="padding: 4px 8px; font-size: 11px; background: #fee2e2; color: #ef4444; border: 1px solid #fca5a5; border-radius: 6px; cursor: pointer;">Γ£à Approve</button>
                                                    <button type="button" onclick="rejectDeletePpt(${p.id})" style="padding: 4px 8px; font-size: 11px; background: #f3f4f6; color: #4b5563; border: 1px solid #d1d5db; border-radius: 6px; cursor: pointer;">Γ¥î Reject</button>
                                                </div>
                                            `;
                                        } else {
            ...
            <div class="card">
                ...
                <div class="form-section-title">Γ₧ò Upload New Presentation</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="bulk-preview-container" style="display:none; margin-top:15px; border-top: 1px solid var(--border); padding-top: 15px;">
                    <p style="font-weight:600; color:var(--success); text-align:center; margin-bottom:15px;">Γ£à <span id="bulk-record-count">0</span> records parsed successfully.</p>
