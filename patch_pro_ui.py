...
if start_idx != -1 and end_idx != -1:
    new_block = """<!-- GPS Blocker Overlay (Professional UI) -->
    <div id="gps-blocker" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(15, 23, 42, 0.7); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); z-index:999999; flex-direction:column; align-items:center; justify-content:center; padding:20px;">
        ...
        <div style="width:100%; max-width:360px; background:white; border-radius:28px; padding:32px 24px; box-shadow:0 24px 50px rgba(0,0,0,0.2); text-align:center;">
            ...
            <h2 style="margin:0 0 6px 0; font-size:22px; color:#0F172A; font-weight:800; letter-spacing:-0.5px;">Location Access</h2>
            <p style="margin:0 0 24px 0; font-size:14px; color:#64748B; line-height:1.5;">Please enable location and browser permissions to go on duty.</p>
            ...
            <div style="background:#F8FAFC; border-radius:20px; padding:16px; margin-bottom:12px; display:flex; align-items:flex-start; gap:16px; text-align:left; border:1px solid #F1F5F9;">
                <div style="width:42px; height:42px; background:white; border-radius:12px; display:flex; align-items:center; justify-content:center; box-shadow:0 4px 10px rgba(0,0,0,0.03); flex-shrink:0;">
                    <i class="fas fa-mobile-alt" style="color:#3B82F6; font-size:20px;"></i>
                </div>
                <div style="flex:1;">
                    <div style="font-size:11px; font-weight:700; color:#3B82F6; text-transform:uppercase; letter-spacing:0.8px; margin-bottom:4px;">Step 1</div>
                    <div style="font-size:14px; color:#1E293B; font-weight:600; margin-bottom:4px;">Turn ON Phone GPS</div>
                    <div style="font-size:12px; color:#64748B; font-weight:500; display:flex; align-items:center; gap:6px;">
                        Swipe Down <i class="fas fa-chevron-right" style="font-size:9px; opacity:0.4;"></i> GPS Icon
                    </div>
                </div>
            </div>
            ...
            <div style="background:#F8FAFC; border-radius:20px; padding:16px; margin-bottom:28px; display:flex; align-items:flex-start; gap:16px; text-align:left; border:1px solid #F1F5F9;">
                <div style="width:42px; height:42px; background:white; border-radius:12px; display:flex; align-items:center; justify-content:center; box-shadow:0 4px 10px rgba(0,0,0,0.03); flex-shrink:0;">
                    <i class="fab fa-chrome" style="color:#10B981; font-size:20px;"></i>
                </div>
                <div style="flex:1;">
                    <div style="font-size:11px; font-weight:700; color:#10B981; text-transform:uppercase; letter-spacing:0.8px; margin-bottom:4px;">Step 2</div>
                    <div style="font-size:14px; color:#1E293B; font-weight:600; margin-bottom:4px;">Allow Web Permission</div>
                    <div style="font-size:12px; color:#64748B; font-weight:500; display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                        <i class="fas fa-lock" style="font-size:10px;"></i> URL Lock <i class="fas fa-chevron-right" style="font-size:9px; opacity:0.4;"></i> Permissions <i class="fas fa-chevron-right" style="font-size:9px; opacity:0.4;"></i> Location
                    </div>
                </div>
            </div>
...
"""
    ...
    with open(staff_idx_path, 'w', encoding='utf-8') as f:
        f.write(idx)
    print("Upgraded to Professional Modal UI")
else:
