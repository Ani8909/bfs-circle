...
$page_title = 'Pre-EMI vs Full-EMI';
$page_subtitle = 'Calculate interest-only payments during construction';
...
<style>
    ...
    .res-value { font-size: 42px; font-weight: 800; color: #db2777; text-align: center; margin-bottom: 30px; font-family: 'Outfit', sans-serif; }
...
<div class="view-container">
    ...
    <div class="calc-layout">
        <div class="calc-inputs">
            ...
            <div class="input-group"><label>Disbursed So Far</label><div class="input-wrapper"><span class="prefix">₹</span><input type="number" id="disb" value="1000000" oninput="calc()"></div></div>
            <div class="input-group"><label>Total Sanctioned</label><div class="input-wrapper"><span class="prefix">₹</span><input type="number" id="tot" value="3000000" oninput="calc()"></div></div>
            <div class="input-group"><label>ROI (%)</label><div class="input-wrapper"><input type="number" id="roi" value="8.5" oninput="calc()"></div></div>
        ...
        <div class="calc-results">
            <div class="res-label">Current Pre-EMI (Interest Only)</div>
            ...
            <div class="res-sub-grid">
                <div class="res-sub-item"><div class="s-lbl">Future Full-EMI</div><div class="s-val" id="r-full">₹0</div></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function calc() { 
            const d = parseFloat(document.getElementById('disb').value)||0;
            ...
            const pre = d*(r/1200);
            const full = (r===0||ten===0)?0: ((r/1200)*t/(1-Math.pow(1+r/1200, -ten*12)));
            document.getElementById('res-main').innerText = '₹'+fmt(pre);
            document.getElementById('r-full').innerText = '₹'+fmt(full);
            if(chart) { chart.data.datasets[0].data = [pre, full]; chart.update(); }
         }
