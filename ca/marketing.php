...
$apply_link = $base_url . "/apply.php?ref=" . urlencode($ref);
$wa_text = urlencode("Hi! You can apply for your Loan through my official link here: " . $apply_link);
?>
...
<div class="card" style="margin-bottom: 24px; padding: 24px; text-align: center;">
    <h3 style="font-family: 'Outfit'; font-size: 16px; margin-bottom: 8px;">Office QR Flyer</h3>
    <p style="font-size: 13px; color: var(--text-muted); margin-bottom: 20px;">Print and display this in your office so clients can scan & apply for loans instantly.</p>
    ...
    <div style="width: 200px; height: 280px; background: linear-gradient(180deg, var(--primary) 0%, var(--primary-hover) 100%); border-radius: 16px; margin: 0 auto 20px; position: relative; overflow: hidden; box-shadow: 0 10px 30px rgba(15, 23, 42, 0.2);">
        ...
        <div style="padding: 20px; color: white; text-align: center;">
            <div style="font-family:'Outfit'; font-weight:800; font-size:16px; margin-bottom:4px; color:var(--accent);">APPLY NOW</div>
