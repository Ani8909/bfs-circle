...
<style>
    ...
    .btn-pitch { background: var(--primary); color: white; border: none; padding: 8px 16px; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; transition: 0.2s; display: inline-flex; align-items: center; gap: 6px; text-decoration: none; box-shadow: 0 4px 10px rgba(234,88,12,0.2); }
    .btn-pitch:hover { transform: translateY(-1px); box-shadow: 0 6px 15px rgba(234,88,12,0.3); }
...
<div class="vault-layout">
    ...
    <div class="metric-grid">
        <div class="metric-box">
            <div class="metric-icon" style="color: var(--text-primary); background: #f1f5f9;"><i data-lucide="shield"></i></div>
            <div>
        ...
        <div class="metric-box">
            <div class="metric-icon" style="color: var(--text-primary); background: #f1f5f9;"><i data-lucide="landmark"></i></div>
            <div>
        ...
        <div class="metric-box">
            <div class="metric-icon" style="color: var(--text-primary); background: #f1f5f9;"><i data-lucide="trending-up"></i></div>
            <div>
        ...
        <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:24px; flex-wrap:wrap; gap:16px;">
            <div>
                <h3 style="margin:0; font-size:20px; font-weight:800; color:#0f172a; display:flex; align-items:center; gap:8px;">
                    <i data-lucide="database" style="color:var(--text-primary);"></i> Scalable Vault Data
                </h3>
